...
const EVENT_ACCESSIBILITY_URL = "https://tinkerhub.frappe.cloud/tinkerspace/accessibility";
              ...
              >
                <svg className="w-5 h-5 text-[#00979C]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path
                    ...
                    strokeWidth={2}
                    d="M10 5a2 2 0 104 0 2 2 0 00-4 0zm9 7h-6l1 9h-4l1-9H5m7 0V9m0 3h0"
                  />
                </svg>
                Accessibility
              </a>
